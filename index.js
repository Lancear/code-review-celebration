...
async function onPageLoad() {
  ...
  document.github.organization.style.width = Math.max(document.github.organization.value?.length + 2, 3) + "ch";
  document.github.repository.style.width = Math.max(document.github.repository.value?.length + 2, 3) + "ch";
